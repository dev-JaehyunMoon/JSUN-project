    ...
    <div class="wrapper ">
        ...
        <div class="content grid">
            ...
            <div class="content_center">
                ...
                <div class="simple_view user_management mb_50">
                    <div class="simple_card full">
                        <p class="simple_text">전체회원</p>
                        <p class="simple_data">100</p>
                    </div>
                    <div class="simple_card">
                        <p class="simple_text">새로운 회원</p>
                        <p class="simple_data">+55</p>
                    </div>
                    <div class="simple_card">
                        <p class="simple_text">정상 회원</p>
                        <p class="simple_data">98</p>
                    </div>
                    <div class="simple_card gray">
                        <p class="simple_text">탈퇴 회원</p>
                        <p class="simple_data">-2</p>
                    </div>
                    <!-- <div class="simple_card gray">
                        <p class="simple_text">휴면 회원</p>
                        <p class="simple_data">92</p>
                    </div> -->
                </div>
                    ...
                    <table class="tab long_tab click_tab">
                        ...
                        <tbody>
                            <tr onclick=" ">
                                ...
                                <td>Gildong12@gmail.com</td>
                                <td>정상</td>
                                <td>2022-10-10</td>
                                <td><i class="fw_9 co_orange">1,000코인</i></td>
                            </tr>
                            <tr onclick=" ">
                                <td>99</td>
                                <td><i class="fw_9">홍길동</i></td>
