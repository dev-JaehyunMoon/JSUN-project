            ...
            <div class="content_left">
                ...
                <div class="menu_part">
                    ...
                    <div class="sub_menu_part">
                        <button type="button" class="sub_menu" onclick="">일반 사용자
                            관리</button>
                        <!-- <button type="button" class="sub_menu" onclick="location.href='1005_MMBR.html'">가맹점
                            관리</button> -->
                ...
                <div class="menu_part ac">
                    ...
                    <div class="sub_menu_part" style="display: block;">
                        <button type="button" class="sub_menu ac" onclick="location.href='2001_PRTNR.html'">사용처 목록</button>
                    </div> -->
                </div>
            ...
            <div class="content_center">
                ...
                <div class="content_head">
                    ...
                    <div class="flow">
                        ...
                        <p class="flow_text"> - 게시판 관리 - <i class="co_navy"> 게시판 내역</i></p>
                    </div>
                </div>
