        ...
        <div class="content grid">
                ...
                <div class="tab_section mb_20">
                    ...
                    <table class="tab long_tab ">
                        ...
                        <tbody>
                            <tr>
                                <td>100</td>
                                <td><a href="1006_MMBR.html" class="link">홍길동</a></td>
                                <td>Gildong12</td>
                                <!-- <td>강남미용실</td> -->
                                <td>10,000 코인</td>
                                <td>10,000 KRW</td>
            ...
            <div class="content_right">
                ...
                <div class="right_head">
                    <button type="button" class="filter_head">충전 내역 검색</button>
                </div>
                <hr>
                <div class="right_content">
                    
                    <div class="inp_part mb_30">
                        <p class="inp_title">결제일시</p>
