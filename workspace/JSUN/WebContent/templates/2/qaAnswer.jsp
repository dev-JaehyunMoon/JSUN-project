    ...
    <div class="pop_wrap" id="canclePop">
        <div>
            <div class="pop">
                ...
                <div class="pop_btm">
                    <button type="button" class="btn btm_btn mint" onclick="location.href='question.jsp'">확인</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="wrapper ">
        ...
        <div class="content grid">
            ...
            <div class="content_center">
                ...
                <!-- tab_menu -->
                <div class="tab_menu">
                    <button type="button" class="main_tab ac" onclick="">일반회원 문의</button>
                </div>
                <hr class="under_tab">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 20px 30px;">
                                            <div class="textarea_wrap">
                                                <textarea class="inp" maxlength="1000" placeholder="1,000자 이내로 답변 내용을 작성해주세요"></textarea>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
