...
<html lang="en">
  ...
  <body>
    <!-- 삭제 클릭 -->
    <div class="pop_wrap" id="deletePop">
      <div>
        <div class="pop" style="height: 235px; top: calc(50% - 215px)">
          ...
          <div class="pop_content">
            <p class="pop_ment">해당 이벤트를 삭제하시겠습니까?</p>
            <p class="pop_ment">이벤트 삭제 시 되돌릴 수 없습니다.</p>
          </div>
      ...
      <div class="content grid">
        ...
        <div class="content_center">
          ...
          <div class="tab_content mt_0">
            <p class="sub_title mb_15">이벤트 상세</p>
            <div class="tab_section mb_20">
              <table class="tab row_tab">
                ...
                <tbody>
                  <tr>
                    <th>번호</th>
                    <td><i class="fw_9">1</i></td>
                  </tr>
                  <tr>
                    <th>상태</th>
                    <td><i class="fw_9">진행중</i></td>
                  </tr>
                  <tr>
                    <th>이벤트명</th>
                    <td><i class="fw_9">이벤트명</i></td>
                  </tr>
                  <tr>
                    <th>이벤트 내용</th>
                    <td><i class="fw_9">이벤트 내용</i></td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div class="btn_section">
              <button type="button" class="btn gray_ol openPop" data-id="noEditPop" onclick="">
                수정
                <!-- 클릭 시 eventDetail.jsp로 이동 -->
              </button>
