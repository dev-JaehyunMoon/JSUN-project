        ...
        <div class="content grid">
            ...
            <div class="content_center">
                ...
                <div class="content_head">
                    ...
                    <div class="flow">
                        ...
                        <p class="flow_text"> - 코인 관리 - <i class="co_navy"> 결제 내역</i></p>
                    </div>
                </div>
                ...
                <div class="simple_view coin_management mb_50">
                    <div class="simple_card full pt_30">
                        ...
                        <p class="simple_data">3,000,000 XGP</p>
                        <p class="won">(3,000,000 KRW)</p>
                    </div>
                    <div class="simple_card pt_30">
                        <p class="simple_text">당월 총 결제 코인</p>
                        <p class="simple_data">500,000 XGP</p>
                ...
                <div class="tab_section mb_20">
                    ...
                    <table class="tab long_tab no_pointer">
                        ...
                        <tbody>
                            <tr>
                                <td>100</td>
                                <td><a href="1001_MMBR.html" class="link">홍길동</a></td>
                                <td>Gildong12</td>
                                <td>10,000 XGP (10,000 KRW)</td>
            ...
            <div class="content_right">
                ...
                <div class="right_head">
                    <button type="button" class="filter_head">결제 내역 검색</button>
                </div>
                <hr>
