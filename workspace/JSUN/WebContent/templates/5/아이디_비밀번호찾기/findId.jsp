...
<body>
	...
	<section class="sectionContainer">
              ...
              <!--복붙한부분  -->
                  <div class="content">
                            <div class="contentDiv">
                                    ...
                                    <div class="contentDivDivDiv">
                                        <div class="contentDivDivDivDiv">
                                            <div class="contentDivDivDivDivDiv">
                                                <h3 class="contentDivDivDivDivDivH3">아이디를 잊으셨나요?</h3>
                                                <div class="contentDivDivDivDivDivDiv"></div>
                                                <p class="contentDivDivDivDivDivP">이름과 휴대폰 번호를 입력하면 문자로 아이디를 보내드릴게요.</p>
                                            </div>
                                                    ...
                                                    <label>
                                                        <div class="contentDivDivDivDivDiv2Div">
                                                            <div class="contentDivDivDivDivDiv2DivDiv">
                                                                <input name="name" type="text" placeholder="이름" class="emailInputbox" value=""></div>
                                                            </div>
                                                        </label>
                                                        ...
                                                        <div class="contentDivDivDivDivDiv2Div">
                                                            <div class="contentDivDivDivDivDiv2DivDiv">
                                                                <input name="phoneNumber" type="tel" placeholder="휴대폰번호" class="emailInputbox" value=""></div>
                                                            </div>
                                                        </label>
                                                        ...
                                                        <button
                                                            ...
                                                            <div class="resettingTextDiv">
                                                                ...
                                                                <span class="resettingTextDivSpan">아이디 전송하기</span>
								...
								<div class="footerDivDiv"></div>
							</div>
						</div>
					</div>
				</div>
				<div id="portal-root" class="footerDivDivDiv"></div>
			</div>
		...
		<div class="footDiv">
			...
			</div><footer class="footContainer">
            <div class="footDiv">
                <div class="footDivDiv1">
                    <div class="footDivDiv1Div1">
                        <div class="footDivDiv1Div1Div1">
