...
<body class="bodysection">
    <header class="header">
				...
				<div class="centered o__centered o__reversed header__meta_wrapper">
					...
					<div class="centeredDiv header_site_name">
						...
						<div class="header_logo">
							...
							<img alt="CLASS101+Help Center" height="347" src="rewrite.png">
							</a>
						</div>
					</div>
					<div class="right_side">
						...
						<div class="right_side_header_links">
							...
							<!-- 오른쪽부분 내용 -->
							 <a target="_blank" rel="noopener" href="rewrite.png" class="header_home_url"> 
        ...
        <h2 class="listADivh2">
        <span class="listADivh2Span">홈페이지 개편 안내(2023년1월23일부터 적용)</span></h2>
     ...
     <div class="listADivDiv"> 
        ...
        <div class="listADivDiv2">
          <div>
            <span class="listADivDiv2Span">작성자:</span>class101
              <br> 1주일 전에 업데이트됨
          </div>
        </div>
      </div>
        ...
        <h2 class="list2Divh2">
        	<span class="list2Divh2Span">다른 계정에서 이용하고 싶어요</span></h2>
      ...
      <div class="list2Div2">
        ...
        <div class="list2Div2DivDiv">
          <div>
            <span class="list2Div2DivDivSpan">작성자:</span>class101
              <br> 이번 주에 업데이트됨
          </div>
        </div>
      </div>
      ...
      <div class="list3DivDiv">
        ...
        <div class="list3DivDiv2">
          <div>
            <span class="list3DivDiv2Span">작성자:</span>class101
              <br> 1주일 전에 업데이트됨
          </div>
        </div>
      </div>
      ...
      <div class="list4Div2">
        ...
        <div class="list4Div2DivDiv">
          <div>
            <span class="list4Div2DivDivSpan">작성자:</span>class101
              <br> 1주일 전에 업데이트됨
          </div>
        </div>
      </div>
      ...
      <div class="list5DivDiv">
        ...
        <div class="list5DivDiv2">
          <div>
            <span class="list5DivDiv2Span">작성자:</span>class101
              <br> 1주일 전에 업데이트됨
          </div>
        </div>
      </div>
      ...
      <div class="list6DivDiv">
        ...
        <div class="list6DivDivDiv2">
          <div>
            <span class="list6DivDivDiv2Span">작성자:</span>class101
              <br> 1주일 전에 업데이트됨
          </div>
        </div>
      </div>
