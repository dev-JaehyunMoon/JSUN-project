            ...
            <div class="footDivDiv1">
                <div class="footDivDiv1Div1">
                    <div class="footDivDiv1Div1Div1">
                        <svg class="footDivDiv1Div1Div1Svg" width="100%" height="100%" viewBox="0 0 152 32">
                            <path fill="#000"
                            ...
                            <path fill="#000" d="M32.1808 5.44H26.98V26.56H40.7146L42.5824 22.0203H32.1808V5.44Z">
                            </path>
                        </svg>
                    </div>
                ...
                <div class="footDivDiv1Div3">
                    <div class="footDivDiv1Div3Div">클래스101</div>
                ...
                <div class="footDivDiv1Div5">
                    ...
                    <div class="footDivDiv1Div5Div2">
                        <button class="footDivDiv1Div5Div2Button">
                            <span class="footDivDiv1Div5Div2ButtonSpan">문의하기</span>
                        </button>
            ...
            <div class="footDivDiv2">
                <div class="footDivDiv2Div1">
                    <div class="footDivDiv2Div1Div">
                        <div class="footDivDiv2Div1DivDiv">
                            <a class="footDivDiv2Div1DivDivA" href="https://class101.net/">CLASS101 Korea</a>
                            <a class="footDivDiv2Div1DivDivA" href="https://class101.co/">CLASS101 USA</a>
                            <a class="footDivDiv2Div1DivDivA" href="https://class101.jp/">CLASS101 Japan</a>
                ...
                <div class="footDivDiv2Div2">
                    ...
                    <div class="footDivDiv2Div2Div2">
                        주식회사 클래스101 | 대표 공대선 | 서울특별시 강남구 테헤란로 302, 1-11층, 13층(역삼동, 위워크타워) | ask@101.inc | 전화번호:
                        1800-2109 |
                        클라우드 호스팅: Amazon Web Services Korea LLC | 사업자등록번호 : 457-81-00277 | 통신판매업신고 : 2022-서울강남-02525 |
