...
<body>
							...
							<div class="mainContainerDiv2DivDivDiv" offset="0">
								<div class="mainContainerDiv2DivDivDivDiv">
									...
									<button type="button" icon-position="0"
										class="mainContainerDiv2DivDivDivDivButton likeButton" color="white"
										fill="false"
								...
								<path
													...
													fill="#FFF"> </path> </svg>
											<svg xmlns="http://www.w3.org/2000/svg" width="24" class="heart"
  ...
  <path fill-rule="evenodd"
										...
										<span
											class="mainContainerDiv2DivDivDivDivButtonSpanButtonSpan">286</span>
									</button>
									<button type="button" icon-position="0"
									...
									<button type="button" icon-position="2"
										...
										<span class="mainContainerDiv2DivDivDivDivButton3Span">
											<img class="mainContainerDiv2DivDivDivDivButton3SpanImg"
											src="profile.png">
										</span>
									</button>
								</div>
								...
								<div class="mainContainerDiv2DivDivDivDiv2">
									<div class="mainContainerDiv2DivDivDivDiv2Div">
										<div class="mainContainerDiv2DivDivDivDiv2DivDiv"
											id="swiper-26">
											<div class="mainContainerDiv2DivDivDivDiv2DivDivDiv">
												<div class="mainContainerDiv2DivDivDivDiv2DivDivDivDiv"
													...
													<div class="mainContainerDiv2DivDivDivDiv2DivDivDivDivDiv">
														...
														<div class="mainContainerDiv2DivDivDivDiv3DivDiv2Div">
															<div
																class="mainContainerDiv2DivDivDivDiv2DivDivDivDivDivDiv"
																color="#FFF" backgroundcolor="rgba(0, 0, 0, 0.56)">
																<div color="#FFF"
																	class="mainContainerDiv2DivDivDivDiv2DivDivDivDivDivDivDiv">
																	#일상</div>
															</div>
															<div
																...
																color="#FFF" backgroundcolor="rgba(0, 0, 0, 0.56)">
																<div color="#FFF"
																	class="mainContainerDiv2DivDivDivDiv2DivDivDivDivDivDiv2Div">
																	#여행</div>
															</div>
															<div
																...
																color="#FFF" backgroundcolor="rgba(0, 0, 0, 0.56)">
																<div color="#FFF"
																	class="mainContainerDiv2DivDivDivDiv2DivDivDivDivDivDiv3Div">
																	#소통</div>
															</div>
															<div
																...
																color="#FFF" backgroundcolor="rgba(0, 0, 0, 0.56)">
																<div color="#FFF"
																	class="mainContainerDiv2DivDivDivDiv2DivDivDivDivDivDiv4Div">
																	#취미</div>
															</div>
															<div
																...
																color="#FFF" backgroundcolor="rgba(0, 0, 0, 0.56)">
																<div color="#FFF"
																	class="mainContainerDiv2DivDivDivDiv2DivDivDivDivDivDiv5Div">
																	#맛집</div>
															</div>
															<div
																...
																color="#FFF" backgroundcolor="rgba(0, 0, 0, 0.56)">
																<div color="#FFF"
																	class="mainContainerDiv2DivDivDivDiv2DivDivDivDivDivDiv6Div">
																	#카페</div>
															</div>
															<div
																class="mainContainerDiv2DivDivDivDiv2DivDivDivDivDivH3">
																메모를 돈 버는데 활용합니다. 메모를 돈 버는데 활용합니다. 메모를 돈 버는데 활용합니다. 메모를 돈
																버는데 활용합니다.</div>
														</div>
				...
				<div class="mainContainerDiv3">
					<div class="mainContainerDiv3Div"></div>
				</div>
			</div>
		</div>
				...
				<div class="footDivDiv1">
					...
					<div class="footDivDiv1Div5">
						<div class="footDivDiv1Div5Div1">
							...
							<div class="footDivDiv1Div5Div1Div2">오전 10시 ~ 오후 6시 (주말,
								공휴일 제외)</div>
						</div>
				...
				<div class="footDivDiv2">
					...
					<div class="footDivDiv2Div2">
						<div class="footDivDiv2Div2Div1">
							<div class="footDivDiv2Div2Div1Div">
								...
								<a class="footDivDiv2Div2Div1DivA" href="" rel="noreferrer"><b>개인정보
									...
									rel="noreferrer">제휴/협력 문의</a> <a
									class="footDivDiv2Div2Div1DivA" href="" rel="noreferrer">PR
									관련 문의</a> <a class="footDivDiv2Div2Div1DivA" href=""
									rel="noreferrer">지식재산권 침해 신고 센터</a>
							</div>
						</div>
						<div class="footDivDiv2Div2Div2">주식회사 REWRITE | 대표 오태양 |
							...
							457-81-00277 | 통신판매업신고 : 2022-서울강남-02525 | REWRITE는 통신판매중개자로서
							중개하는 거래에 대하여 책임을 부담하지 않습니다.</div>
					</div>
				</div>
