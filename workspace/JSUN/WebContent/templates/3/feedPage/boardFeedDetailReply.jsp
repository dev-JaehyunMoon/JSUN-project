...
<link rel="stylesheet" href="boardFeedDetailReply.css">
...
<body>
	<div class="mainContainer">
		<div class="mainContainerDiv">
			<div class="mainContainerDivDiv">
				...
				<div class="mainContainerDivDivDiv2">
					<div class="mainContainerDivDivDiv2Div">
						...
						<div class="mainContainerDivDivDiv2DivDiv">
							<div data-test-id="community-post" data-object-id="0015ace377"
								data-user-id="0014a89373"
								class="mainContainerDivDivDiv2DivDivDiv">
								<div width="100%" class="mainContainerDivDivDiv2DivDivDivDiv">
										...
										<div class="mainContainerDivDivDiv2DivDivDivDivDivDiv">
											<a href="/user/kakao2274046169/posts"
												...
												class="mainContainerDivDivDiv2DivDivDivDivDivDivASpan"><img
													...
													class="mainContainerDivDivDiv2DivDivDivDivDivDivASpanImg"></span></a>
										</div>
										<div class="mainContainerDivDivDiv2DivDivDivDivDivDiv2">
											<div class="mainContainerDivDivDiv2DivDivDivDivDivDiv2Div">
												<div md="Caption1" font-weight="600" color="#3a3a3a"
													class="mainContainerDivDivDiv2DivDivDivDivDivDiv2DivDiv">그루브타는
													허수아비</div>
												<div
													class="mainContainerDivDivDiv2DivDivDivDivDivDiv2DivDiv2"></div>
											</div>
											<div md="Caption2"
												class="mainContainerDivDivDiv2DivDivDivDivDivDiv2Div2">2022.
												6. 7.</div>
										</div>
									</div>
									<div marginleft="0"
									...
									<div marginleft="0"
										class="mainContainerDivDivDiv2DivDivDivDivDiv3">
										<div class="mainContainerDivDivDiv2DivDivDivDivDiv3Div">
											<div position="0"
									...
									<div marginleft="0"
										class="mainContainerDivDivDiv2DivDivDivDivDiv4"></div>
									<div marginleft="0"
										class="mainContainerDivDivDiv2DivDivDivDivDiv5"></div>
								</div>
							</div>
							<div data-test-id="community-post" data-object-id="00150ccfa7"
								data-user-id="000fe28cf4"
								class="mainContainerDivDivDiv2DivDivDivDiv2">
								<div width="100%"
										...
										<div class="mainContainerDivDivDiv2DivDivDivDiv2DivDivDiv">
											<a href="/user/kakao2273724107/posts"
												...
												class="mainContainerDivDivDiv2DivDivDivDiv2DivDivDivASpan"><img
													src="https://class101.net/images/default-user.png"
													class="mainContainerDivDivDiv2DivDivDivDiv2DivDivDivASpanImg"></span></a>
										</div>
										<div class="mainContainerDivDivDiv2DivDivDivDiv2DivDivDiv2">
											<div
												class="mainContainerDivDivDiv2DivDivDivDiv2DivDivDiv2Div">
												<div md="Caption1" font-weight="600" color="#3a3a3a"
													class="mainContainerDivDivDiv2DivDivDivDiv2DivDivDiv2DivDiv">베르누이</div>
												<div
													class="mainContainerDivDivDiv2DivDivDivDiv2DivDivDiv2DivDiv2"></div>
											</div>
											<div md="Caption2"
												class="mainContainerDivDivDiv2DivDivDivDiv2DivDivDiv2Div2">2022.
												6. 7.</div>
										</div>
									</div>
									<div marginleft="0"
									...
									<div marginleft="0"
										class="mainContainerDivDivDiv2DivDivDivDiv2DivDiv3">
										<div class="mainContainerDivDivDiv2DivDivDivDiv2DivDiv3Div">
											<div position="0"
											...
											<div position="0"
												...
												<button type="button" icon-position="2"
													class="mainContainerDivDivDiv2DivDivDivDiv2DivDiv3DivDiv3Button "
													color="transparent">
													<span
									...
									<div marginleft="0"
										class="mainContainerDivDivDiv2DivDivDivDiv2DivDiv4"></div>
									<div marginleft="0"
										class="mainContainerDivDivDiv2DivDivDivDiv2DivDiv5"></div>
								</div>
							</div>
							<div data-test-id="community-post" data-object-id="00157770b0"
								data-user-id="000e4ab23b"
								class="mainContainerDivDivDiv2DivDivDivDiv4">
								<div width="100%"
										...
										<div class="mainContainerDivDivDiv2DivDivDivDiv4DivDivDiv">
											<a href="/user/kakao2273684155/posts"
												...
												class="mainContainerDivDivDiv2DivDivDivDiv4DivDivDivASpan"><img
													src="https://class101.net/images/default-user.png"
													class="mainContainerDivDivDiv2DivDivDivDiv4DivDivDivASpanImg"></span></a>
										</div>
										<div class="mainContainerDivDivDiv2DivDivDivDiv4DivDivDiv2">
											<div
												class="mainContainerDivDivDiv2DivDivDivDiv4DivDivDiv2Div">
												<div md="Caption1" font-weight="600" color="#3a3a3a"
													class="mainContainerDivDivDiv2DivDivDivDiv4DivDivDiv2DivDiv">ㅎㅎ</div>
												<div
													class="mainContainerDivDivDiv2DivDivDivDiv4DivDivDiv2DivDiv2"></div>
											</div>
											<div md="Caption2"
												class="mainContainerDivDivDiv2DivDivDivDiv4DivDivDiv2Div2">2022.
												6. 7.</div>
										</div>
									</div>
									<div marginleft="0"
									...
									<div marginleft="0"
										class="mainContainerDivDivDiv2DivDivDivDiv4DivDiv3">
										<div class="mainContainerDivDivDiv2DivDivDivDiv4DivDiv3Div">
											<div position="0"
											...
											<div position="0"
												...
												<button type="button" icon-position="2"
													class="mainContainerDivDivDiv2DivDivDivDiv4DivDiv3DivDiv3Button "
													color="transparent">
									...
									<div marginleft="0"
										class="mainContainerDivDivDiv2DivDivDivDiv4DivDiv4"></div>
									<div marginleft="0"
										class="mainContainerDivDivDiv2DivDivDivDiv4DivDiv5"></div>
								</div>
							</div>
							<div data-test-id="community-post" data-object-id="0016e2e6ff"
								data-user-id="000ed63eab"
								class="mainContainerDivDivDiv2DivDivDivDiv5">
								<div width="100%"
										...
										<div class="mainContainerDivDivDiv2DivDivDivDiv5DivDivDiv">
											<a href="/user/kakao2273683856/posts"
												...
												class="mainContainerDivDivDiv2DivDivDivDiv5DivDivDivASpan"><img
													src="https://class101.net/images/default-user.png"
													class="mainContainerDivDivDiv2DivDivDivDiv5DivDivDivASpanImg"></span></a>
										</div>
										<div class="mainContainerDivDivDiv2DivDivDivDiv5DivDivDiv2">
											<div
												class="mainContainerDivDivDiv2DivDivDivDiv5DivDivDiv2Div">
												<div md="Caption1" font-weight="600" color="#3a3a3a"
													class="mainContainerDivDivDiv2DivDivDivDiv5DivDivDiv2DivDiv">판소리하는
													험프리</div>
												<div class="sc-8ea0b616-8 kLNtzU"></div>
											</div>
											<div md="Caption2"
												class="mainContainerDivDivDiv2DivDivDivDiv5DivDivDiv2Div2">2022.
												6. 7.</div>
										</div>
									</div>
									<div marginleft="0"
									...
									<div marginleft="0"
										class="mainContainerDivDivDiv2DivDivDivDiv5DivDiv3">
										<div class="mainContainerDivDivDiv2DivDivDivDiv5DivDiv3Div">
											<div position="0"
									...
									<div marginleft="0"
										class="mainContainerDivDivDiv2DivDivDivDiv5DivDiv4"></div>
									<div marginleft="0"
										class="mainContainerDivDivDiv2DivDivDivDiv5DivDiv5"></div>
								</div>
							</div>
						</div>
					</div>
				</div>
				<div class="mainContainerDivDivDiv3">
					<form class="mainContainerDivDivDiv3Form">
						<div class="mainContainerDivDivDiv3FormDiv">
							<div class="mainContainerDivDivDiv3FormDivDiv">
								<div class="mainContainerDivDivDiv3FormDivDivDiv">
									<button type="button" icon-position="0"
										class="mainContainerDivDivDiv3FormDivDivDivButton "
										color="default">
										<span class="mainContainerDivDivDiv3FormDivDivDivButtonSpan"><label
								...
								<textarea placeholder="댓글을 입력해주세요." name="content"
									class="mainContainerDivDivDiv3FormDivDivTextarea" rows="1"
									style="overflow-x: hidden; overflow-wrap: break-word; height: 48px;"></textarea>
							</div>
						</div>
						<button kind="textGray" type="submit"
							class="mainContainerDivDivDiv3FormButton">
							<div class="mainContainerDivDivDiv3FormButtonDiv">
								<span class="mainContainerDivDivDiv3FormButtonDivSpan"><svg
										xmlns="http://www.w3.org/2000/svg" width="24" height="24"
										fill="none" viewBox="0 0 24 24"
										class="mainContainerDivDivDiv3FormButtonDivSpanSvg">
									<path fill-rule="evenodd"
											class="mainContainerDivDivDiv3FormButtonDivSpanSvgPath"
			...
			<div class="mainContainerDivDiv2">
				<div class="mainContainerDivDiv2Div"></div>
			</div>
		</div>
	</div>
</body>
